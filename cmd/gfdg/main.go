...
import (
	...
	"github.com/futuredigitalgames/fdg-chain/lib/fdgclient"
...
const (
	clientIdentifier = "gfdg" // Client identifier to advertise over the network
)
...
func prepare(ctx *cli.Context) {
	...
	case ctx.GlobalIsSet(utils.LegacyTestnetFlag.Name):
		log.Info("Starting Gfdg on Ropsten testnet...")
	...
	case ctx.GlobalIsSet(utils.RinkebyFlag.Name):
		log.Info("Starting Gfdg on Rinkeby testnet...")

	case ctx.GlobalIsSet(utils.GoerliFlag.Name):
		log.Info("Starting Gfdg on Görli testnet...")

	case ctx.GlobalIsSet(utils.DeveloperFlag.Name):
		log.Info("Starting Gfdg in ephemeral dev mode...")

	case !ctx.GlobalIsSet(utils.NetworkIdFlag.Name):
		log.Info("Starting Gfdg on Ethereum mainnet...")
	}
...
// Gfdg is the main entry point into the system if no special subcommand is ran.
