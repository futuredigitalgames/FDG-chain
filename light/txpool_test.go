...
func TestTxPool(t *testing.T) {
	...
	blockchain, _ := core.NewBlockChain(sdb, nil, params.TestChainConfig, fdgash.NewFullFaker(), vm.Config{}, nil, nil)
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, fdgash.NewFaker(), sdb, poolTestBlocks, txPoolTestChainGen)
	...
	lightchain, _ := NewLightChain(odr, params.TestChainConfig, fdgash.NewFullFaker(), nil)
	txPermanent = 50
