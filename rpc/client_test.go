...
// This test reproduces https://github.com/futuredigitalgames/fdg-chain/issues/17837 where the
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-fdg-test-ipc-%d-%d", os.Getpid(), rand.Int63())
